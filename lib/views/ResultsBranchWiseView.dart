...
class ResultsBranchWiseView extends StatelessWidget {
  ...
  const ResultsBranchWiseView({Key key, this.yearSelector, this.internSwitch, this.sortSwitch}) : super(key: key);
        ...
        itemBuilder: (context, index) {
          return Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.of(context).pushNamed('/result_details_branchwise',arguments: {'url' : model.branchResults[index].studentDetails, 'sort' : sortSwitch});
              },
            ),
          );
        },
