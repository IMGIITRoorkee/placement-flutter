...
class ResultsCompanyWiseView extends StatelessWidget {
  ...
  const ResultsCompanyWiseView({Key key, this.yearSelector, this.internSwitch, this.sortSwitch}) : super(key: key);
  ...
  Widget _resultDisplay(BuildContext context, ResultsCompanyWiseViewModel model) {
    bool changed = (model.yearIndex != yearSelector) || (model.internSwitch != internSwitch) || (model.sortSwitch != sortSwitch);
        ...
        itemBuilder: (context, index) {
          return Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.of(context).pushNamed('/result_details_companywise',arguments: {'url' : model.companyResults[index].detail, 'sort': model.sortSwitch});
              },
            ),
          );
        },
