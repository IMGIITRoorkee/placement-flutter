class EndPoints {
  ...
  static const String PROFILES_APPLIED = '/api/placement_and_internship/profiles/applied/';
  static const String PROFILES_ME = '/api/placement_and_internship/profiles/not_closed/';
  ...
  static final String RESUME_DETAIL = '/api/placement_and_internship/generate_resume/';
  static final String CALENDAR_EVENTS = '/api/placement_and_internship/calendar/';
